...
function App() {
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Minting your Armed Bear NFT...");
    setClaimingNft(true);
    ...
    blockchain.smartContract.methods
      ...
      .once("error", (err) => {
        ...
        if(err.code === 4001) {
          setFeedback("We were told you rejected the transaction.  Sorry???");
        } else {
      ...
      //string: https://mint.armedbears.io/api/6

      
      //contract address on ropsetn
      //0x0567b8272df3fB4E3b0cF1f50FfdAA1A1BC766B8
    /*
    blockchain.smartContract.methods
        ...
        <div className="inner-2">
          <div className="inner-3">
            ...
            <div className="counter">
              Counter: {blockchain.account == null ? "0" : (data.totalSupply)}/10000
            </div>
            ...
            {Number(data.totalSupply) === 10000 ? (
              <>
                ...
                <div className="opensea-link">
                  Dont worry, you're not missing out! You can still get Armed Bears on{" "}
                  <a
                    // target={"_blank"}
